...
namespace CookiesAuthorization.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromForm]LoginRequest loginRequest)
        {
            ...
            var calculatedHash = _hashingService.SaltedHashFromPassword(loginRequest.Password, requestedUser.Salt);
        ...
        [HttpGet(Endpoints.Auth.AccessDenied)]
        public IActionResult AccesDenied()
        {
            return Unauthorized("You are not authorized to view requested resource, login as a user with proper permissions.");
        }
        ...
        private User CreateNewUser(RegisterRequest registerRequest)
        {
            ...
            byte[] salt = _hashingService.SaltFromUser(user);
            user.Salt = salt;
            user.PasswordHash = _hashingService.SaltedHashFromPassword(registerRequest.Password, user.Salt);
